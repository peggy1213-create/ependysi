...
CREATE TABLE IF NOT EXISTS holding_lots (
  ...
  target_price  REAL,
  stop_loss     REAL,
  plan_id       INTEGER,            -- dca_plans.id if auto-generated by a 定期定額 plan
  created_at    TEXT    NOT NULL
);
...
CREATE TABLE IF NOT EXISTS dca_plans (
  ...
  end_date      TEXT,                        -- ISO or NULL = ongoing
  schedule      TEXT    NOT NULL,            -- JSON: [{ "day": 6, "amount": 3000 }, ...]
  active        INTEGER NOT NULL DEFAULT 1,
  notes         TEXT,
  last_run_date TEXT,                        -- last debit date materialised (cursor)
  created_at    TEXT    NOT NULL
);
CREATE INDEX IF NOT EXISTS idx_dca_plans_ticker ON dca_plans(ticker);
